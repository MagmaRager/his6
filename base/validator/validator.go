...
var stringErrorMap = map[string]string{
	"lessThan": "[name] 的长度不能小于 [max] 个字符",
	"equal":    "[name] 的长度须为 [min] 个字符",
	"atLeast":  "[name] 的长度至少为 [min] 个字符",
	"between":  "[name] 的长度须在 [min] 到 [max] 个字符之间",
}

var numberErrorMap = map[string]string{
	"lessThan": "[name] 不得大于 [max]",
	"equal":    "[name] 须等于 [min]",
	"atLeast":  "[name] 不得小于 [min]",
	"between":  "[name] 须在 [min] 和 [max] 之间",
}

var arrayErrorMap = map[string]string{
	"lessThan": "集合 [name] 的长度不得大于 [max]",
	"equal":    "集合 [name] 的长度须为 [min]",
	"atLeast":  "集合 [name] 的长度不得小于 [min]",
	"between":  "集合 [name] 的长度须在 [min] 和 [max] 之间",
}
